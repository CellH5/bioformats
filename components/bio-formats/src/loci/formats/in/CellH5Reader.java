...
//	 }
  ...
  private void parseStructure() {
	 ...
	 pathToImageData += position + "/image/channel";
	 ...
	 core[0].sizeC = ctzyx[0];
	 core[0].sizeT = ctzyx[1];
	 core[0].sizeZ = ctzyx[2];
	 core[0].sizeY = ctzyx[3];
	 core[0].sizeX = ctzyx[4];
	 
	 core[0].resolutionCount = 1;
	 core[0].thumbnail = false;
	 core[0].imageCount = getSizeC() * getSizeT() * getSizeZ();
	 core[0].dimensionOrder = "XYZCT";
	 
	 core[0].pixelType = FormatTools.UINT8;
     core[0].dimensionOrder = "XYZCT";
     core[0].rgb = false;
     core[0].thumbSizeX = 128;
     core[0].thumbSizeY = 128;
     ...
     store.setImageName(imageName + " test", 0);

	 

//	 int[] origin = {0, 0, 0, 0, 0};
//	 Object image = new Object();
//	 try {
//		image = netcdf.getArray(pathToImageData, origin, ctzyx);
//		byte[][][][] bimage = (byte[][][][])(image);
//		
...
//		c.setId("C:/Users/sommerc/data/cellh5_demo/0013.c5");
